...
####CHANGE THESE####
PATH="/Users/mann/github/tortoise/healthy/" #CHANGE ME to your working directory
RAW="/Volumes/histolytica/tortoise/raw/healthy" #CHANGE ME to where your raw fastq files are
